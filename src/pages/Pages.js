  ...
  return (
    ...
    {/* Main menu */}
      ...
      <div className="dropdown">
        <div className="dopdown">OUR PRODUCTS</div>
      ...
      <div className="New_Products">New products</div>
      ...
      <div>
        ...
        {/* Product listing is here with product description */}
